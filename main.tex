...
\begin{frame}{Trajectory test}
    \movie[width=3cm,height=2cm,poster]{Pure rotation}{PR.mp4}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{Trajectory test}
    \movie[width=3cm,height=2cm,poster]{90 degree turn}{90degree.mp4}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{Trajectory test}
    \movie[width=3cm,height=2cm,poster]{Translation with rotation}{360.mp4}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
