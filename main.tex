...
\begin{frame}{Trajectory test}
    \movie[width=3cm,height=2cm,poster]{Pure rotation}{PR.avi}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{Trajectory test}
    \movie[width=3cm,height=2cm,poster]{90 degree turn}{90degree.avi}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{Trajectory test}
    \movie[width=3cm,height=2cm,poster]{Translation with rotation}{360.avi}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
